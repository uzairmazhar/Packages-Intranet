...
@section('body')
    <div class="content-body">
        <section id="form-control-repeater">
            <form action="{{URL::to('news/add')}}" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="file-repeater">News Information</h4>
                                ...
                                <div class="card-body">
                                    <div class="form row">
                                        ...
                                        <div class="form-group col-md-12 mb-2">
                                            ...
                                            <textarea rows="5" class="form-control" name="news_description" maxlength="255" required>{{Input::old('news_description')}}</textarea>
